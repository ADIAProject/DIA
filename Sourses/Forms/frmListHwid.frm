...
Private MeCaptionView                   As String
Private MeCaptionInstall                As String
...
Dim i                                   As Integer
    ...
    If mbooSelectInstall Then
        ...
        Me.Caption = MeCaptionView & " " & lvFolders.ListItems.Count & " " & strMessages(124) & " " & miCurrentListCount & ")"
    Else
        ...
        Me.Caption = MeCaptionInstall & " " & lvFolders.ListItems.Count & " " & strMessages(124) & " " & miCurrentListCount & ")"
    End If
End Sub
...
' Выставляем шрифт элементов (действует только на те для которых не поддерживается Юникод)
    ...
    ' Название формы
    MeCaptionView = LocaliseString(StrPathFile, strFormName, "frmListHwidView", Me.Caption)
    MeCaptionInstall = LocaliseString(StrPathFile, strFormName, "frmListHwidInstall", Me.Caption)
