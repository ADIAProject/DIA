    ...
    If ImageListHandle <> 0 Then
        ...
        If Picture.Type = vbPicTypeBitmap Then
            If PropUseMaskColor = True Then
                ImageList_AddMasked ImageListHandle, BitmapHandleFromPicture(Picture), WinColor(PropMaskColor)
            Else
                ImageList_Add ImageListHandle, BitmapHandleFromPicture(Picture), 0
            End If
