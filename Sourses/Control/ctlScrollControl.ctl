...
Private Sub UserControl_Initialize()
    ...
    If pASMWrapper <> 0 Then
        ...
        'ASM-Wrapper mit Maschinencode befьllen
        ASM(0) = &H90
...
Private Sub UserControl_Terminate()
    ...
    If pASMWrapper <> 0 Then
        ...
        If Counter = 0 Then
            'Wrapper kann von VB aus gelцscht werden
