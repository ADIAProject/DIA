...
'! -----------------------------------------------------------
Public Function APIFunctionPresent(ByVal FunctionName As String, _
...
'! -----------------------------------------------------------
Private Function DLLOCX(ByVal lngHWnd As Long, _
                        ByVal Path As String, _
                        ByVal mbRegister As Boolean) As Boolean
